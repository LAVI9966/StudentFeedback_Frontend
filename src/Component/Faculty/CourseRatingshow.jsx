...
const CourseRatingshow = () => {
  const { courseId } = useParams();
  console.log("hello mf ", courseId);
  ...
  useEffect(() => {
    const fetch = async () => {
      const fetchedrating = await axios.get(
        `https://studentfeedback-backend.onrender.com/fetchcourseratings/${courseId}`
      );
  ...
  const questionLabels = {
    question1: "How would you rate the course content?",
    question2: "How would you rate the difficulty of the course?",
    question3: "How would you rate the workload of the course?",
    question4: "How would you rate the overall course experience?",
    question5:
                  ...
                  <div className="col-md-6 border border-dark rounded">
                    ...
                    <div className=" mt-5">
                      <ul>
                        <li>
                          {" "}
                          <h5> How would you rate the course content?</h5>
                        </li>
                        <li>
                          {" "}
                          <h5>
                        ...
                        <li>
                          {" "}
                          <h5> How would you rate the course difficulty?</h5>
                        </li>
                        <li>
                          {" "}
                          <h5> How would you rate the course workload?</h5>
                        </li>
                        <li>
                          {" "}
                          <h5>
...
export default CourseRatingshow;
